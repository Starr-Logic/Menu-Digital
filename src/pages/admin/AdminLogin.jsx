        ...
        <div className="bg-slate-900/40 backdrop-blur-xl rounded-3xl border border-slate-800/60 shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-8">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3.5 bg-slate-950/50 border border-slate-800 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:border-amber-500/50 focus:ring-4 focus:ring-amber-500/10 transition-all font-medium"
                required
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 disabled:bg-slate-800 disabled:text-slate-500 disabled:border-slate-700 disabled:shadow-none text-slate-950 font-black py-3.5 px-4 rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(245,158,11,0.2)] hover:shadow-[0_0_30px_rgba(245,158,11,0.4)]"
            >
              {loading ? (
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/60 text-center">
            <p className="text-xs text-slate-500 font-medium">
              {t('testing_credentials')} <span className="text-slate-300 font-bold bg-slate-800 px-2 py-0.5 rounded">admin</span> / <span className="text-slate-300 font-bold bg-slate-800 px-2 py-0.5 rounded">admin</span>
            </p>
          </div>
        </div>
      </div>
