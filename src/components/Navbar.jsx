...
import { ChefHat, Globe, Utensils, Layers, QrCode, Plus } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-30 bg-slate-950/80 backdrop-blur-md border-b border-slate-900 shadow-xl" id="main-header">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center py-4 md:py-0 md:h-16 gap-4 md:gap-0">
          
          {/* Logo and Branding */}
          <div className="flex items-center gap-3" id="brand-container">
            <div className="p-2 bg-gradient-to-tr from-amber-500 to-orange-500 text-slate-950 rounded-xl shadow-lg shadow-amber-500/10">
          ...
          {/* Controls Side */}
          <div className="flex flex-wrap items-center gap-4" id="controls-container">
            
            {/* Language Switcher Selector */}
            <div className="flex items-center gap-1.5 bg-slate-900 px-3 py-2 rounded-xl border border-slate-800" id="lang-switcher-wrapper">
              ...
              >
                ...
                <option value="km" className="bg-slate-950 text-slate-200">ភាសាខ្មែរ (Khmer)</option>
              </select>
            </div>

            {/* Mode Switcher */}
            <div className="flex p-1 bg-slate-900 rounded-xl border border-slate-800" id="nav-tabs-wrapper">
              <button 
                id="btn-nav-customer"
              ...
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold tracking-wide transition-all relative ${
                  activeTab === 'kitchen' 
