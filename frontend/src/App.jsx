      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'customer' && (
          <div className="space-y-8">
            ...
            {/* Table Header Banner */}
            <div className="relative overflow-hidden rounded-4xl border border-slate-800/80 bg-linear-to-br from-slate-900 via-slate-900 to-slate-950 p-6 sm:p-8 shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
